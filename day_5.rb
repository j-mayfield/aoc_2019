...
# fail unless IntCodeProcessor.new(test_input_1).run_intcode(0).last.eql?(0)
# fail unless IntCodeProcessor.new(test_input_1).run_intcode(1).last.eql?(1)
# fail unless IntCodeProcessor.new(test_input_1).run_intcode(2).last.eql?(1)
#
# test_input_2 = '3,3,1105,-1,9,1101,0,0,12,4,12,99,1'
# fail unless IntCodeProcessor.new(test_input_2).run_intcode(0).last.eql?(0)
# fail unless IntCodeProcessor.new(test_input_2).run_intcode(1).last.eql?(1)
# fail unless IntCodeProcessor.new(test_input_2).run_intcode(2).last.eql?(1)
