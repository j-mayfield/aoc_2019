...
# https://rubygems.org/gems/binary_search_tree/versions/2.0
...
class Moon
  ...
  def update_x_vel(other_moon)
    if @x_pos < other_moon.x_pos
      @x_vel           += 1
      other_moon.x_vel -= 1
    elsif @x_pos > other_moon.x_pos
      @x_vel           -= 1
      other_moon.x_vel += 1
    end
  end

  def update_y_vel(other_moon)
    if @y_pos < other_moon.y_pos
      @y_vel           += 1
      other_moon.y_vel -= 1
    elsif @y_pos > other_moon.y_pos
      @y_vel           -= 1
      other_moon.y_vel += 1
    end
  end

  def update_z_vel(other_moon)
    if @z_pos < other_moon.z_pos
      @z_vel           += 1
      other_moon.z_vel -= 1
    elsif @z_pos > other_moon.z_pos
      @z_vel           -= 1
      other_moon.z_vel += 1
    end
  end
